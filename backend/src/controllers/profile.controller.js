...
// POST /api/profile/upload-cv  — stores CV bytes in DB as BLOB (same approach as pitch deck)
...
// GET /api/profile/cv — proxy CV PDF through backend (same pattern as /projects/:id/deck)
